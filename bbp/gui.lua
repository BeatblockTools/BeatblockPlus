...
function gui.pushStyle()
	...
	imgui.PushStyleColor_Vec4(imgui.ImGuiCol_WindowBg,                  imgui.ImVec4_Float(1.00, 1.00, 1.00, 1.00))
	imgui.PushStyleColor_Vec4(imgui.ImGuiCol_ChildBg,                   imgui.ImVec4_Float(0.00, 0.00, 0.00, 0.00))
	imgui.PushStyleColor_Vec4(imgui.ImGuiCol_PopupBg,                   imgui.ImVec4_Float(1.00, 1.00, 1.00, 1.00))
	...
	imgui.PushStyleColor_Vec4(imgui.ImGuiCol_TitleBg,                   imgui.ImVec4_Float(1.00, 1.00, 1.00, 1.00))
	...
	imgui.PushStyleColor_Vec4(imgui.ImGuiCol_ScrollbarBg,               imgui.ImVec4_Float(1.00, 1.00, 1.00, 1.00))
